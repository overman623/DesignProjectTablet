...
public class DialogShareTimeConfirm extends AlertDialog {
    ...
    public DialogShareTimeConfirm(Context context) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    public DialogShareTimeConfirm(Context context, int themeResId) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }
