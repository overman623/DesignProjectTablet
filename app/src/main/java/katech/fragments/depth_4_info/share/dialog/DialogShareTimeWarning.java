...
public class DialogShareTimeWarning extends AlertDialog {
    ...
    public DialogShareTimeWarning(Context context) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    public DialogShareTimeWarning(Context context, int themeResId) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }
