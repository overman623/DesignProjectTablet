...
public class DialogNavigationFinish extends AlertDialog {
    ...
    public DialogNavigationFinish(Context context) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    public DialogNavigationFinish(Context context, int themeResId) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }
