...
public class DialogLayoutFindPassword extends AlertDialog {
    ...
    public DialogLayoutFindPassword(Context context) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    public DialogLayoutFindPassword(Context context, int themeResId) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    protected DialogLayoutFindPassword(Context context, boolean cancelable, OnCancelListener cancelListener) {
