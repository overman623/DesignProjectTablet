...
public class DialogLayoutLoginNaver extends AlertDialog {
    ...
    public DialogLayoutLoginNaver(Context context) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }

    public DialogLayoutLoginNaver(Context context, int themeResId) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
    }
